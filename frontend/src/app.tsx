...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'targets/:targetId', lazy: () => import('@/features/targets/detail-page.tsx') },
      { path: 'targets/:targetId/edit', lazy: () => import('@/features/targets/form-page.tsx') },
      ...
      { path: 'config/resources', lazy: () => import('@/features/config-resources/page.tsx') },
      { path: 'users', lazy: () => import('@/features/users/page.tsx') },
      { path: 'scan-config', lazy: () => import('@/features/scan-config/page.tsx') },
      { path: 'scan-config/new', lazy: () => import('@/features/scan-config/form-page.tsx') },
      { path: 'scan-config/:scheduleId', lazy: () => import('@/features/scan-config/form-page.tsx') },
