...
def _validate_swift(swift: str) -> bool:
    ...
    SWIFT_DENY_LIST = {
        ...
        "EFFECTIVE", "DEPENDENT", "PROJECTED", "FOLLOWING",
        "OTHERWISE", "GENERATED", "PURCHASED", "REMAINDER", "THRESHOLD",
        "CONCLUDED", "CUSTODIAN", "CONTINUED", "DELIVERED",
        "ESTIMATED", "IMPORTANT", "SECONDARY", "FOREGOING", "MANDATORY", "PUBLISHED", "BEGINNING", "CUSTODIAL",
        "PARAGRAPH", "PRIMARILY", "MATERIALS", "RESULTING", "DESCRIBED",
        "SELECTING", "CONVERTED", "MECHANISM",
        "ALLOCATED", "INVESTORS", "DISCLOSED", "NOTIFYING", "BORROWING",
        "COMPLIANT", "PERFORMED", "INITIALLY", "CONFIRMED", # AI4Privacy 10k FP analysis — 8-letter words with valid country codes at pos 4-5
        ...
        "PRODUCTS", "PROGRAMS", "PROJECTS", "PROTOCOL", "RELATING", "RELEVANT", "REPORTED", "RESEARCH", "RESIDENT",
