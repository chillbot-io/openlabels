...
# Pattern definitions: (regex, entity_type, confidence, group_index)
...
_add(r'\b(gho_[a-zA-Z0-9]{36})\b', 'GITHUB_TOKEN', 0.99, 1)
_add(r'\b(ghu_[a-zA-Z0-9]{36})\b', 'GITHUB_TOKEN', 0.99, 1)
_add(r'\b(ghs_[a-zA-Z0-9]{36})\b', 'GITHUB_TOKEN', 0.99, 1)
_add(r'\b(ghr_[a-zA-Z0-9]{36})\b', 'GITHUB_TOKEN', 0.99, 1)
