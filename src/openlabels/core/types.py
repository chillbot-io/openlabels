...
KNOWN_ENTITY_TYPES: frozenset[str] = frozenset([
    ...
    # CONTACT
    "PHONE", "PHONE_NUMBER", "PHONENUMBER", "US_PHONE_NUMBER", "TELEPHONE", "PHONE_EXT",
    ...
    "IBAN", "IBAN_CODE",
    "ABA_ROUTING", "ROUTING", "ROUTING_NUMBER", "BANK_ROUTING",
    "BIC", "SWIFT", "SWIFT_BIC",
    ...
    "MONERO_ADDRESS", "POLKADOT_ADDRESS",
    ...
    # SECRETS - Infrastructure & DevOps
    "HEROKU_KEY", "DATADOG_KEY", "NEWRELIC_KEY", "DATABASE_URL",
    "VAULT_TOKEN", "ATLASSIAN_TOKEN", "GRAFANA_KEY",
    "LINEAR_KEY", "DOPPLER_TOKEN",
    "OPENAI_KEY", "ANTHROPIC_KEY",
    "VERCEL_TOKEN", "SUPABASE_KEY", "PLANETSCALE_TOKEN",
    ...
    # PROFESSIONAL
    "PROFESSION", "OCCUPATION", "JOB", "JOB_TITLE", "EMPLOYEE_ID",
