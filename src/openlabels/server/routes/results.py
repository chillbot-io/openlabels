...
async def export_results(
    ...
    When ``catalog.enabled`` is True, DuckDB reads from Parquet with all
    filters pushed down (no Python-side post-filtering).  Otherwise the
    existing PostgreSQL streaming path is used.
    """
    import csv
    import io
    import json
